...
<?php
$styles = ob_get_clean();
renderHeader('Restablecer contraseña', $styles);
renderBanner('Restablecer contraseña');
?>
...
<div class="container">
  ...
  <form method="post" action="/password/reset" novalidate>
    ...
    <input type="hidden" name="selector" value="<?= Helpers::e($selector) ?>">
    ...
    <input id="confirmPassword" type="password" name="password_confirm" minlength="6" required autocomplete="new-password">

    <button type="submit" class="btn-blue btn-slim">Guardar contraseña</button>
  </form>
